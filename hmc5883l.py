...
class HMC5883L:
    ...
    def __init__(self,i2c_id, scl=4, sda=5, address=30, gauss='1.3', declination=(0, 0)):
        self.i2c = i2c = machine.I2C(i2c_id,scl=machine.Pin(scl), sda=machine.Pin(sda), freq=100000)
